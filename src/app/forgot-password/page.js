        ...
        <div className='grid grid-cols-1 md:grid-cols-2 items-center bg-white'>
          ...
          <div className='h-screen flex flex-col justify-center bg-white overflow-auto grid-item p-5 md:p-8'>
            <div className=''>
              ...
              <h1 className='text-2xl text-black md:text-4xl font-bold text-left pb-1.5'>Forgot Password</h1>
              ...
              <button className='bg-[#1DAB61] mt-2 mb-5 hover:bg-[#37c77d] transition duration-300 h-14 text-base font-bold rounded-[10px] p-2 w-full uppercase text-white'>
                Send OTP
              </button>
