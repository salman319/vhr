      ...
      <header className="admin-header">
        <div className='flex justify-between items-center px-4 md:px-10 py-3 shadow-lg bg-white'>
          ...
          <div className='flex gap-2 items-center'>
            <Link href={''} className='bg-primary hover:bg-green rounded-lg w-8 h-8 hidden md:flex justify-center items-center'>
            ...
            <Link href={''} className='bg-primary hover:bg-green rounded-lg w-8 h-8 flex justify-center items-center'>
